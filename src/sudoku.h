...
class Sudoku
{
    ...
    std::vector<bool> get_possible_locations_row(int n, int r);
    std::vector<bool> get_possible_locations_col(int n, int c);
    std::vector<bool> get_possible_locations_block(int n, int r, int c);
